...
import { getAssociatedTokenAddressSync as getAssociatedTokenAddressSync3, NATIVE_MINT as NATIVE_MINT3, TOKEN_2022_PROGRAM_ID as TOKEN_2022_PROGRAM_ID3 } from "@solana/spl-token";
import { poolPda, pumpFeePda, pumpPda, pumpAmmPda as pumpAmmPda2 } from "@pump-fun/pump-swap-sdk";
...
// src/sdk.ts
import { coinCreatorVaultAtaPda as coinCreatorVaultAtaPda2, coinCreatorVaultAuthorityPda as coinCreatorVaultAuthorityPda2 } from "@pump-fun/pump-swap-sdk";
...
var PumpSdk = class {
  ...
  async updateFeeShares({
    ...
    return await this.offlinePumpFeeProgram.methods.updateFeeShares(
      ...
      authority,
      mint,
      coinCreatorVaultAta: coinCreatorVaultAtaPda2(coinCreatorVaultAuthority, NATIVE_MINT2, TOKEN_PROGRAM_ID2)
    }).remainingAccounts(
...
var AMM_GLOBAL_PDA = pumpAmmPda2([import_buffer.Buffer.from("amm_global")]);
...
var AMM_GLOBAL_VOLUME_ACCUMULATOR_PDA = pumpAmmPda2([
  import_buffer.Buffer.from("global_volume_accumulator")
]);
...
export {
  ...
  ZeroShareError,
  ammCreatorVaultPda2 as ammCreatorVaultPda,
